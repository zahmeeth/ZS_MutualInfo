...
function ZS_MutualInfo(url, auth, auth_cb, timeout, async_job_check_time_ms, service_version) {
    var self = this;
    ...
    var _auth_cb = auth_cb;
     ...
     this.run_flux_mutual_information_analysis = function (params, _callback, _errorCallback) {
        ...
        return json_call_ajax(_url, "ZS_MutualInfo.run_flux_mutual_information_analysis",
    ...
    this.status = function (_callback, _errorCallback) {
        ...
        return json_call_ajax(_url, "ZS_MutualInfo.status",
