...
def get_config():
    ...
    for nameval in config.items(get_service_name() or 'ZS_MutualInfo'):
        retconfig[nameval[0]] = nameval[1]
    return retconfig

config = get_config()

from ZS_MutualInfo.ZS_MutualInfoImpl import ZS_MutualInfo  # noqa @IgnorePep8
impl_ZS_MutualInfo = ZS_MutualInfo(config)
...
class Application(object):
    ...
    def __init__(self):
        submod = get_service_name() or 'ZS_MutualInfo'
        ...
        self.rpc_service.add(impl_ZS_MutualInfo.run_flux_mutual_information_analysis,
                             ...
                             types=[dict])
        self.method_authentication['ZS_MutualInfo.run_flux_mutual_information_analysis'] = 'required'  # noqa
